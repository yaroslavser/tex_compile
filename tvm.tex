...
\item {\tt F945} --- {\tt FINDBYCODEHASH} ($s$ -- $t$), returns the list of accounts with code hash specified in 256 bit of $s$ {\em Slice\/}.
\item {\tt F946} --- {\tt FINDBYDATAHASH} ($s$ -- $t$), returns the list of accounts with data hash specified in 256 bit of $s$ {\em Slice\/}.
