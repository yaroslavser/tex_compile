...
\item {\tt F944} --- {\tt FINDBYINITCODEHASH} ($s$ -- $t$), returns the list of accounts with initial code hash specified in 256 bit of $s$ {\em Slice\/}.
\item {\tt F945} --- {\tt FIND_BY_CODE_HASH} ($s$ -- $t$), returns the list of accounts with code hash specified in 256 bit of $s$ {\em Slice\/}.
\item {\tt F946} --- {\tt FIND_BY_DATA_HASH} ($s$ -- $t$), returns the list of accounts with data hash specified in 256 bit of $s$ {\em Slice\/}.
